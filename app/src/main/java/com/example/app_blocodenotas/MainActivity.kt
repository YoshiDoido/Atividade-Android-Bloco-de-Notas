...
import com.example.app_blocodenotas.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            if (textoRecuperado == "") {
                Snackbar.make(view, "Digite um nome para ser anotado", Snackbar.LENGTH_LONG).show()
            } else {
                preferencias!!.salvarAnotacao(textoRecuperado)
                Snackbar.make(view, "Nome anotado com sucesso!", Snackbar.LENGTH_LONG).show()
            }
        }
